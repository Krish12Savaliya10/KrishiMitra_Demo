...
import { At as ArrowRight, R as MapPin, St as ChartColumn, V as Lock, a as UserRound, et as Eye, gt as CircleAlert, ht as CircleCheck, j as Phone, tt as EyeOff, y as ShieldCheck, z as Mail } from "../_libs/lucide-react.mjs";
import { r as useAppData } from "./router-DcyHQImX.mjs";
import { i as ThemeToggle, n as BrandMark } from "./AppShell-DaKle9m-.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/auth-tL2uk99P.js
						...
						children: [
							...
							mode !== "forgot-password" && mode !== "otp-login" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
								...
								children: [renderStep(), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									children: [mode === "login" ? "Sign in to dashboard" : step < 3 ? "Continue" : "Complete Registration", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "h-4 w-4 transition-transform group-hover:translate-x-0.5" })]
								})]
							}),
