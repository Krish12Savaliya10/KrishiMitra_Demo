...
import { At as CalendarClock, J as ListTodo, Mt as Brain, Ot as Calendar, Rt as Activity, S as ShieldAlert, Y as ListChecks, _ as Sprout, _t as Clock, bt as CircleCheck, c as Timer, ct as Droplets, d as Thermometer, gt as CloudRain, it as Flag, kt as CalendarRange, lt as Droplet, mt as Cloud, n as Wind, o as TriangleAlert, p as Target, rt as FlaskConical, v as Sparkles, xt as CircleAlert, yt as ClipboardList } from "./_libs/lucide-react.mjs";
import { r as useAppData, t as Route$11 } from "./_ssr/router-C6v2fw80.mjs";
...
import { t as FarmSwitcher } from "./_ssr/FarmSwitcher-DLtXqUEb.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_app.crop-plan-B9cMVvxo.js
...
function NextTaskCard({ planTasks }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "glass rounded-2xl p-5 border border-primary/20 shadow-sm relative overflow-hidden group cursor-pointer hover:bg-secondary/20 transition-colors",
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
					className: "text-sm font-semibold text-foreground flex items-center gap-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CalendarClock, { className: "w-4 h-4 text-primary" }), " Next Up"]
				}), isHighPriority && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "text-[10px] uppercase font-bold tracking-widest text-destructive bg-destructive/10 px-2 py-0.5 rounded-full flex items-center gap-1",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "w-3 h-3" }), " High Priority"]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center gap-3 text-[11px] font-medium text-muted-foreground border-t border-border/50 pt-3",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "flex items-center gap-1",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "w-3.5 h-3.5" }), new Date(nextTask.date).toLocaleDateString("en-IN", {
						weekday: "short",
						month: "short",
						day: "numeric"
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "uppercase tracking-widest bg-secondary/80 px-2 py-0.5 rounded-md",
					children: nextTask.category
				})]
			})
		]
	});
...
function CropPlanPage() {
	...
	const [aiForm, setAiForm] = (0, import_react.useState)({ cropName: "" });
	...
	const sowingDate = activePlan?.sowingDate ? new Date(activePlan.sowingDate).toLocaleDateString("en-IN", {
		day: "numeric",
		month: "short",
		year: "numeric"
	}) : "—";
	const harvestDate = activePlan?.expectedHarvestDate ? new Date(activePlan.expectedHarvestDate).toLocaleDateString("en-IN", {
		day: "numeric",
		month: "short",
		year: "numeric"
	}) : "—";
	const durationDays = activePlan?.sowingDate && activePlan?.expectedHarvestDate ? Math.max(1, Math.round((new Date(activePlan.expectedHarvestDate) - new Date(activePlan.sowingDate)) / 864e5)) : 0;
