...
import { E as Search, L as Navigation, Ot as Calendar, P as Plus, U as MapPin, _t as Clock, at as Eye, ct as Droplets, d as Thermometer, gt as CloudRain, ht as CloudSun, m as Sun, n as Wind, t as X, tt as Gauge, v as Sparkles } from "./_libs/lucide-react.mjs";
import { r as useAppData } from "./_ssr/router-C6v2fw80.mjs";
import { r as PageHeader } from "./_ssr/AppShell-B2DYmKXV.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_app.weather-D7EWfxcq.js
...
async function fetchWeatherForLocation(locationQuery) {
	...
	const weatherRes = await fetch(`http://localhost:5005/api/weather?latitude=${lat}&longitude=${lon}`);
